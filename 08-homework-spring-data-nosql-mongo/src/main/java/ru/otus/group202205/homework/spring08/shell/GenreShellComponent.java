...
public class GenreShellComponent {
  ...
  public String createGenre(@ShellOption(value = "--name") String name) {
    ...
    try {
      ...
      return String.format("Genre with id %s created!",
          genre.getId());
  ...
  public String readGenre(@ShellOption(value = "--id") String id) {
    try {
  ...
  public String updateGenre(@ShellOption(value = "--name") String name, @ShellOption(value = "--id") String id) {
    GenreDto genre = new GenreDto();
    genre.setId(id);
    genre.setName(name);
    try {
      genreService.saveOrUpdate(genre);
      return String.format("Genre with id %s updated!",
          id);
    } catch (LibraryGeneralException e) {
      return e.toString();
    }
  ...
  public String deleteGenresById(@ShellOption(value = "--id") String id) {
    try {
      genreService.deleteById(id);
      return String.format("Genre with id %s deleted!",
          id);
    } catch (LibraryGeneralException e) {
      return e.toString();
    }
