package ru.otus.group202205.homework.spring08.service.mapper.impl;
...
class BookCommentMapperTest {
  ...
  void shouldBeConvertToDtoFromEntity() {
    BookComment bookComment = bookCommentTestDataComponent.getNiceBookCommentForGirlFromTheEarthBook();
