...
import ru.otus.group202205.homework.spring13.dto.BookCommentDto;
import ru.otus.group202205.homework.spring13.dto.BookFullDto;
import ru.otus.group202205.homework.spring13.dto.BookSimpleDto;
...
import ru.otus.group202205.homework.spring13.service.BookCommentService;
import ru.otus.group202205.homework.spring13.service.BookService;
import ru.otus.group202205.homework.spring13.service.mapper.BookCommentMapper;
...
import ru.otus.group202205.homework.spring13.testdata.BookCommentTestDataComponent;
...
@Import({BookCommentTestDataComponent.class, BookTestDataComponent.class, AuthorTestDataComponent.class, GenreTestDataComponent.class, WebSecurityConfig.class})
class BookCommentControllerTest {
  ...
  @WithMockUser(username = "admin", password = "admin", roles = {"ADMIN"})
  @Test
  void shouldBeReturnCode200DeleteBookCommentRedirectToBookComments() throws
      Exception {
    Mockito
        .doNothing()
        .when(bookService)
