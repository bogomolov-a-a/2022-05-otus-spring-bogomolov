...
public enum QuestionType {
   ...
   */
  MULTISELECT("multiselect", 6, 2),
  /**
   * for all questions: Question statement,question type
   */
  DEFAULT("all questions", 2, 0);
  ...
  QuestionType(String type, int questionLineMinimumPartNumber, int questionMinimumCorrectAnswerListCount) {
    this.type = type;
