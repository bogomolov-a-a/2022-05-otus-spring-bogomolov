...
public class BookCommentShellComponent {
  ...
  public String createBookComment(@ShellOption(value = "--text", defaultValue = ShellOption.NULL) String text,
      @ShellOption(value = "--created", defaultValue = ShellOption.NULL) String created, @ShellOption(value = "--book-id") Long bookId) {
    ...
    try {
      ...
      return String.format("Book comment with id %d created!",
          bookComment.getId());
  ...
  public String readBookComment(@ShellOption(value = "--id") Long id) {
    try {
  ...
  public String readBookCommentForSpecifiedBook(@ShellOption(value = "--book-id") Long bookId) {
    try {
  ...
  public String updateBook(@ShellOption(value = "--text", defaultValue = ShellOption.NULL) String text,
      @ShellOption(value = "--book-id", defaultValue = ShellOption.NULL) Long bookId,
      @ShellOption(value = "--created", defaultValue = ShellOption.NULL) String created, @ShellOption(value = "--id") Long id) {
    BookCommentDto bookComment = new BookCommentDto();
    ...
    try {
      ...
      return String.format("Book comment with id %d updated!",
          id);
    } catch (LibraryGeneralException e) {
      return e.toString();
    }
  ...
  public String deleteBookById(@ShellOption(value = "--id") Long id) {
    try {
      ...
      return String.format("Book comment with id %d deleted!",
          id);
    } catch (LibraryGeneralException e) {
      return e.toString();
    }
