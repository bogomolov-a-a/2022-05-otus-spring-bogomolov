package ru.otus.group202205.homework.spring19.zooshop.address.controller;
...
public class AddressController {
  ...
  @Operation(summary = "Create new address", description = "Address must be already created, otherwise will be 422")
  ...
  @Operation(summary = "Get all addresss", description = "Find all addresss with pagination.")
  @GetMapping(value = "/", produces = MediaType.APPLICATION_JSON_VALUE + ";charset=UTF-8")
  public List<AddressDto> findAll(
      @ParameterObject Pageable pageable) {
    return addressService.findAll(org.springframework.data.domain.Pageable
  ...
  @Operation(summary = "Get address info by id")
  ...
  @Operation(summary = "Get address infos by text", description = "search by all field as 'like'")
  @ApiResponse(responseCode = "200",
      content = {@Content(mediaType = MediaType.APPLICATION_JSON_VALUE + ";charset=UTF-8",
          schema = @Schema(implementation = AddressDto.class))})
  @GetMapping(value = "/by/text", produces = MediaType.APPLICATION_JSON_VALUE + ";charset=UTF-8")
  public List<AddressDto> findByText(@RequestParam("text") String text,
      @ParameterObject Pageable pageable) {
    return addressService.findAllBySomeText("%" + text + "%",
  ...
  @Operation(summary = "Update address info")
  @ApiResponse(responseCode = "200",
      content = {@Content(mediaType = MediaType.APPLICATION_JSON_VALUE + ";charset=UTF-8",
          schema = @Schema(implementation = AddressDto.class))})
  ...
  @Operation(summary = "Delete all addresses in db")
  @DeleteMapping("/")
  ...
  @Operation(summary = "Check address existence by id")
