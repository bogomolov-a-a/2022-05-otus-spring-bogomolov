...
@Import({GenreTestDataComponent.class, WebSecurityConfig.class})
class GenreControllerTest {
  ...
  void shouldBeReturnCode200GenreReadCardPageWithId() throws
    ...
    Mockito
        ...
        .findById(1L);
    mvc
        .perform(MockMvcRequestBuilders.get("/genres/1"))
  ...
  @WithMockUser(username = "admin", password = "admin", roles = {"admin"})
  @Test
  void shouldBeReturnCode200DeleteGenreRedirectToGenres() throws
      Exception {
    Mockito
        .doNothing()
        .when(genreService)
        .deleteById(1L);
    mvc
        .perform(MockMvcRequestBuilders.delete("/genres/1"))
        .andExpect(MockMvcResultMatchers
            .status()
            .isOk());
  }
